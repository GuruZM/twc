...
var InView = function(_React$Component) {
  ...
  function InView2(props) {
    ...
    _this.handleNode = function(node2) {
      if (_this.node) {
        _this.unobserve();
        if (!node2 && !_this.props.triggerOnce && !_this.props.skip) {
          _this.setState({
  ...
  _proto.render = function render() {
    ...
    return React2.createElement(as || "div", _extends2({
      ref: this.handleNode
    }, props), children);
  };
  return InView2;
...
function useInView(_temp) {
  ...
  var _React$useState = React2.useState(null), ref = _React$useState[0], setRef = _React$useState[1];
  var callback = React2.useRef();
  var _React$useState2 = React2.useState({
...
var Fragment3 = import_jsx_runtime.Fragment;
...
var Reveal = (props) => {
  ...
  const animationStyles = (0, import_react20.useMemo)(
    () => getAnimationCss({
  ...
  if (isStringLike(children))
    return jsx(TextReveal, { ...props, animationStyles, children: String(children) });
  if ((0, import_react_is.isFragment)(children))
    return jsx(FragmentReveal, { ...props, animationStyles });
  return jsx(Fragment3, { children: import_react20.Children.map(children, (node2, index) => {
    if (!(0, import_react20.isValidElement)(node2))
      return null;
    const nodeDelay = delay + (cascade ? index * duration * damping : 0);
    switch (node2.type) {
      case "ol":
      case "ul":
        return jsx(ClassNames, { children: ({ cx }) => jsx(
          node2.type,
          {
            ...node2.props,
            className: cx(className, node2.props.className),
            style: Object.assign({}, style, node2.props.style),
            children: jsx(Reveal, { ...props, children: node2.props.children })
          }
        ) });
      case "li":
        return jsx(
          InView,
          {
            ...
            children: ({ inView, ref }) => jsx(ClassNames, { children: ({ cx }) => jsx(
              node2.type,
              {
                ...node2.props,
                ref,
          ...
          InView,
          {
            ...
            children: ({ inView, ref }) => jsx(
              "div",
              {
                ...
                children: jsx(ClassNames, { children: ({ cx }) => jsx(
                  node2.type,
                  {
                    ...node2.props,
                    className: cx(childClassName, node2.props.className),
  ...
  return matchIf(
    () => jsx(
      "div",
      {
        ...
        children: children.split("").map((char2, index) => jsx(
          "span",
          {
            css: matchIfOrNull(() => animationStyles)(inView),
            style: {
    ...
    () => jsx(FragmentReveal, { ...props, children })
  )(cascade);
};
...
var AttentionSeeker = (props) => {
  ...
  const [keyframes87, animationCss3] = (0, import_react5.useMemo)(() => getStyles(effect), [effect]);
  return jsx(
    Reveal,
    {
      keyframes: keyframes87,
...
var Bounce = (props) => {
  ...
  const keyframes87 = (0, import_react35.useMemo)(
    () => getStyles2(reverse, direction),
    [direction, reverse]
  );
  return jsx(Reveal, { keyframes: keyframes87, ...rest });
};
...
var Fade = (props) => {
  ...
  const keyframes87 = (0, import_react46.useMemo)(
...
var Flip = (props) => {
  ...
  const keyframes87 = (0, import_react60.useMemo)(
...
var JackInTheBox = (props) => {
  return jsx(Reveal, { keyframes: jackInTheBox, ...props });
};
...
var Roll = (props) => {
  ...
  const keyframes87 = (0, import_react70.useMemo)(() => getStyles5(reverse), [reverse]);
  return jsx(Reveal, { keyframes: keyframes87, ...rest });
};
...
var Rotate = (props) => {
  const { direction, reverse = false, style, ...rest } = props;
  const [keyframes87, animationCss3] = (0, import_react71.useMemo)(
...
var Slide = (props) => {
  const { direction, reverse = false, ...rest } = props;
  const keyframes87 = (0, import_react82.useMemo)(
...
var Zoom = (props) => {
  const { direction, reverse = false, ...rest } = props;
  const keyframes87 = (0, import_react91.useMemo)(
